...
- [ ] **Phase 03: Extract remaining CLI glue into `cli-common`** - Remove the remaining metadata mapping, fatal runner, response-emitter, and doctor scaffolding glue from tool crates
